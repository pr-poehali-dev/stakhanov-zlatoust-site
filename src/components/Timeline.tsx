  ...
  const timelineEvents = [
    {
      ...
      description:
        "Торжественная закладка первого камня будущего промышленного гиганта",
    },
    {
      year: "1942",
      title: "Военное производство",
      description:
        "Перестройка производства для нужд фронта в годы Великой Отечественной войны",
    },
    {
      year: "1955",
      title: "Городской слёт стахановцев",
      description:
        "Масштабное мероприятие по обмену передовым опытом и повышению производительности труда",
    },
    {
      year: "1960",
      title: "Модернизация",
      description:
        "Внедрение новых технологий и расширение производственных мощностей",
    },
  ];
