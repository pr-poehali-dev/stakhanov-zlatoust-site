...
const Index = () => {
  const facts = [
    {
      title: "Златоустовская сталь высшего качества",
      description:
        "Стахановцы завода освоили выплавку особой стали для производства знаменитых златоустовских клинков и инструментов",
      year: "1936",
      category: "Металлургия",
      icon: "⚔️",
    },
    {
      title: "Секреты оружейного мастерства",
      description:
        "Златоустовские оружейники-стахановцы возродили древние технологии булатной стали и гравировки по металлу",
      year: "1937",
      category: "Оружейное дело",
      icon: "🗡️",
    },
    {
      title: "Женщины у мартеновских печей",
      description:
        "Впервые в истории завода женщины-стахановки стали работать у мартеновских печей, показав выдающиеся результаты",
      year: "1937",
      category: "Равенство полов",
      icon: "🔥",
    },
    {
      title: "Горный хрусталь Златоуста",
      description:
        "Стахановцы-камнерезы освоили обработку уральских самоцветов для украшения почётного оружия",
      year: "1938",
      category: "Художественные промыслы",
      icon: "💎",
    },
  ];
