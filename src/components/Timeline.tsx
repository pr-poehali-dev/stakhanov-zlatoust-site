...
const Timeline = () => {
  const events: TimelineEvent[] = [
    ...
    {
      year: "1937",
      title: "Городской слет стахановцев",
      description:
        "15 января 1937 года состоялся городской слет стахановцев. Трудовые коллективы заключили между собой договор и вступили в социалистическое соревнование за лучшие результаты труда",
    },
    {
      year: "1937",
      title: "Массовое движение",
      description: "Более 926 рабочих Златоуста получили звание стахановцев",
    },
    {
      year: "1937",
