...
const Timeline = () => {
  const events: TimelineEvent[] = [
    ...
    },
    {
      ...
      description:
        "15 января состоялся городской слет стахановцев. Трудовые коллективы заключили между собой договор и вступили в социалистическое соревнование за лучшие результаты труда",
    },
  ];
