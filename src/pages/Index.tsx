...
const Index = () => {
  const facts = [
    {
      title: "Рекордная выработка угля",
      description:
        "Алексей Стаханов установил рекорд, добыв за смену 102 тонны угля при норме 7 тонн — превышение в 14,5 раз",
      year: "1935",
      category: "Угольная промышленность",
      icon: "⛏️",
    },
    {
