      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              В 1935-1937 годах стахановское движение охватило Златоустовский
              металлургический завод и инструментальный завод-комбинат им. В.И.
              Ленина. Местные рабочие, вдохновленные примером шахтёра, начали
              устанавливать собственные производственные рекорды в металлургии и
              машиностроении
            </p>
          </div>
        </div>
